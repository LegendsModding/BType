 ...
 */
declare function OPER_Append(
  firstGroup: EntityGroup,
  secondGroup: EntityGroup,
): EntityGroup;
 ...
 * @param secondGroup The second set of entities. Order DOES matter.
 */
declare function OPER_Difference(
  firstGroup: EntityGroup,
  secondGroup: EntityGroup,
): EntityGroup;
 ...
 */
declare function OPER_Intersection(
  firstGroup: EntityGroup,
  secondGroup: EntityGroup,
): EntityGroup;
 ...
 * @param secondGroup The second set of entities. Order does NOT matter.
 */
declare function OPER_SymDifference(
  firstGroup: EntityGroup,
  secondGroup: EntityGroup,
): EntityGroup;
