...
/**
 * Creates a deck from a library where card values are greater than a threshold.
 * @param library The name of the library.
 * @param threshold The value threshold.
 * @returns A new deck containing cards with values greater than the threshold.
 */
export const DECK_MakeFromLibraryValueGreater = (
  library: string,
  threshold: number,
): Deck => {
  const deck: Deck = [];
